...
/**
 * Note: copy and paste from SourceOverrideControllerTest -- variable names are arbitary so I kept changes to a minimum
 * 
 * @author jeffrey
 */
public class RegionOverrideControllerTest extends ParentControllerTest {
  ...
  public void testGetAllOverridesEmpty() throws Exception {
    ...
    ResponseOptions response = given().expect().statusCode(200).when().get("/regionOverride").andReturn();
