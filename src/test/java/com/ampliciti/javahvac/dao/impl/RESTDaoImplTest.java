...
public class RESTDaoImplTest {
    ...
    public static void setUpJetty() throws Exception {
        ...
        //returnUrl = "<a class="vglnk" href="http://localhost" rel="nofollow"><span>http</span><span>://</span><span>localhost</span></a>:" + Integer.toString(testPort) + "/test";
        jettyServer.setHandler(handler);

        jettyServer.start();
    }

    public static void handleHttpRequest(String target, HttpServletRequest request, HttpServletResponse response) throws IOException {
        //stuff here
        try (
