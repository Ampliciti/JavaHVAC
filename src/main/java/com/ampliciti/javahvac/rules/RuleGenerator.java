...
public class RuleGenerator {
  ...
  /**
   * Call this to generate the needed managed rules for the whole application. Note: Server configuration must be
  ...
  /**
   * Generates a single solar cistern rule. Will return null if no cistern exists in the configuration.
   *
   * @return
   */
