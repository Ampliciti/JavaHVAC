...
public class RuleGenerator {
    ...
    /**
     * Call this to generate the needed managed rules for the whole application. Note: Server configuration must be established before calling this method.
     *
     * @return Rules to use.
     */
    ...
    /**
     * Generates a single solar cistern rule. Will return null if no cistern
