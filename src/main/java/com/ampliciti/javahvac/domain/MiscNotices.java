...
/**
 * Class that's used to post misc notices on /info api. This is used for informational messages about the current system
 * state. All it's accessors are static, so really any object can modify it. This shouldn't be used for business logic,
 * rule enforcement, or flow control.
 * 
 * @author jeffrey
 */
