...
public class CurrentNodeState {
  ...
  /**
   * Goes out to all the nodes and asks them for their current state, then stores it in this object. Existing objects in
   * the list are removed if they're no longer connected.
   */
