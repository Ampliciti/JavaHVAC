...
public class Utils {
  ...
  /**
   * Converts a string address from our config file into a Java usable URL object. There are better ways to do this, esp
   * with exception handling, but winter is literally coming and I need this code working soon to heat my house. Don't
   * judge me.
   *
  ...
  public static URL buildUrlFromAddressString(String address) {
    try {
      ...
      throw new RuntimeException(
          "The address passed in was not in a correct format: " + address + ". Expected format is: [IP|DNS]:port", e);
    }
  }
